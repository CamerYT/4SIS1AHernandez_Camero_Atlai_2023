...
class Ejercicios{
    ...
    public void Ejercicio1(){
        ...
        //calculadora
        double num1 = 0.00, suma = 0.00, multi = 1.00, div = 1;
        char operacion;
        ...
        switch(operacion){
                ...
                case 'c':
                    //aca va la division
                    System.out.println("Desea detener la division ingrese el 0: ");
                    ...
                    break;
                default:
                    System.out.println("opcion no valida, sorry :3/");
                break;
        }
